...
module OneboxApiDoc
  describe ParamContainer do
    ...
    let(:test_param) { OneboxApiDoc::TestParamContainer.new }
    ...
    describe "initialize" do
      ...
      describe "nested params" do
        it "set correct nested param" do
          test_param_with_block = OneboxApiDoc::TestParamContainer.new do
          ...
          expect(test_param_with_block._params).to be_an Array
          first_param = test_param_with_block._params.first
          ...
          second_param = test_param_with_block._params.last
